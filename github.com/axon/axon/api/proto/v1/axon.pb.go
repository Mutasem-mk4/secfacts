...
// 	protoc        v3.21.12
// source: api/proto/v1/axon.proto
...
const file_api_proto_v1_axon_proto_rawDesc = "" +
	"\n" +
	"\x17api/proto/v1/axon.proto\x12\aaxon.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"N\n" +
	"\bSeverity\x12\x14\n" +
...
var (
	...
	file_api_proto_v1_axon_proto_rawDescData []byte
)

func file_api_proto_v1_axon_proto_rawDescGZIP() []byte {
	file_api_proto_v1_axon_proto_rawDescOnce.Do(func() {
		file_api_proto_v1_axon_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_v1_axon_proto_rawDesc), len(file_api_proto_v1_axon_proto_rawDesc)))
	})
	return file_api_proto_v1_axon_proto_rawDescData
}

var file_api_proto_v1_axon_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_proto_v1_axon_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
func file_api_proto_v1_axon_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_v1_axon_proto_rawDesc), len(file_api_proto_v1_axon_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
